...
const stageDuration = __ENV.K6_STAGE_DURATION || '120s';
const targetRate = Number(__ENV.K6_TARGET || '900');
const preAllocatedVUs = Number(__ENV.K6_PRE_VUS || '100');
const maxVUs = Number(__ENV.K6_MAX_VUS || '250');
const summaryPath = __ENV.K6_RESULTS_PATH || 'test/results.json';
